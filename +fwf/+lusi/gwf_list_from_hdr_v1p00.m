...
% function [gwfc, rfc, dtc, tStart] = fwf.lusi.gwf_list_from_hdr_v1p00(hdr)
...
nuc              = fwf.lusi.nuc_from_hdr(hdr);
tStart           = seq.t_start/1e6;

[gwfo, rfo, dto] = fwf.lusi.gwf_from_seq(seq);
[~, u, n]        = fwf.lusi.bvluvc_from_hdr(hdr);
R3x3             = fwf.lusi.rm_from_siemens_uvec(u, seq.rot_mode, n*2*pi);
