...
% function [gwf, rf, dt] = fwf.lusi.gwf_from_seq_v1p00(seq)
...
if seq.seq_ver < 1.24
    ga = fwf.lusi.gwf_resample_v1p23(wf1, seq.d_pre);
    gb = fwf.lusi.gwf_resample_v1p23(wf2, seq.d_post);
else
    ga = fwf.lusi.gwf_resample_v1p24(wf1, seq.d_pre);
    gb = fwf.lusi.gwf_resample_v1p24(wf2, seq.d_post);
end
