...
% function [gwf, rfc, dtc, tStart] = fwf.lusi.gwf_from_seq_v2p00(seq, bin_fn)
% By Filip Szczepankiewicz
% Lund University, Lund, Sweden

if nargin < 2 || isempty(bin_fn)
    bin_fn = fwf.lusi.bin_from_sha(seq.bin_hash);
end

dt     = seq.d_grad_rast*1e-6; % s
tStart = seq.t_start/1e6;

wf_parts = fwf.lusi.bin_read(bin_fn);
...
[bvals, g_sca] = fwf.lusi.blist_from_seq(seq);
