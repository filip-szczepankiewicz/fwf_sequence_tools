...
% function [dvs, wfi] = fwf.lusi.dvs_from_experiment(b_list, n_list, i_list, dvs_fn, order, bin_fn)
...
if nargin < 1
    ...
    [dvs, wfi] = fwf.lusi.dvs_from_experiment(b_list, n_list, i_list, dvs_fn, order, bin_fn);
    return
end
