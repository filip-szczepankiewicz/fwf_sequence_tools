function [gwf, rf, dt, x] = dde_optSlew(gamp, s_o, s_i, d , tp, dt, hw, ns_thr, u1, u2)
% function [gwf, rf, dt, x] = fwf.gwf.create.dde_optSlew(gamp, s_o, s_i, d , tp, dt, hw, ns_thr, u1, u2)
%
...
[gwf, rf, dt] = fwf.gwf.create.dde_variSlew(gamp, x(1), x(2), d, tp, dt, u1, u2);
